...
export default function TosPage() {
  const termsCopy = `Terms and Conditions -------------------- Last updated: March 15, 2024
      ...
      purposes of these Terms and Conditions: * Affiliate means an entity that
      ...
      managing authority. * Country refers to: New York, United States * Company
      (referred to as either "the Company", "We", "Us" or "Our" in this
      Agreement) refers to Morse Lane. * Device means any device that can access
      the Service such as a computer, a cellphone or a digital tablet. * Service
      refers to the Website. * Terms and Conditions (also referred as "Terms")
      mean these Terms and Conditions that form the entire agreement between You
      and the Company regarding the use of the Service.* Third-party Social Media Service means any services or
      ...
      Service. * Website refers to FanCreate, accessible from
      <https://fancreate.netlify.app> * You means the individual accessing or using
      ...
      Service. Links to Other Websites ----------------------- Our Service may
      ...
      third-party web sites or services that You visit. Termination -----------
      ...
      the Service will cease immediately. Limitation of Liability
      ----------------------- Notwithstanding any damages that You might incur,
      the entire liability of the Company and any of its suppliers under any
      provision of this Terms and Your exclusive remedy for all of the foregoing
      shall be limited to the amount actually paid by You through the Service or
      100 USD if You haven't purchased anything through the Service. To the
      maximum extent permitted by applicable law, in no event shall the Company
      ...
      if the remedy fails of its essential purpose. Some states do not allow the
      exclusion of implied warranties or limitation of liability for incidental
      or consequential damages, which means that some of the above limitations
      may not apply. In these states, each party's liability will be limited to
      the greatest extent permitted by law. "AS IS" and "AS AVAILABLE"
      Disclaimer ---------- The Service is provided to You "AS IS" and "AS
      ...
      Service, including all implied warranties of merchantability, fitness for
      ...
      or will be corrected. Without limiting the foregoing, neither the Company
      nor any of the company's provider makes any representation or warranty of
      any kind, express or implied: (i) as to the operation or availability of
      ...
      limitations set forth in this section shall be applied to the greatest
      extent enforceable under applicable law. Governing Law ------------- The
      ...
      Disputes Resolution ------------------- If You have any concern or dispute
      about the Service, You agree to first try to resolve the dispute
      informally by contacting the Company. For European Union (EU) Users
      ----------------------------- If You are a European Union consumer, you
      will benefit from any mandatory provisions of the law of the country in
      which you are resident in. United States Legal Compliance
      ...
      and Waiver ----------------------- Severability ~~~~~~~~~~~~ If any
      ...
      the remaining provisions will continue in full force and effect. Waiver
      ...
      any subsequent breach. Translation Interpretation
      -------------------------- These Terms and Conditions may have been
      translated if We have made them available to You on our Service. You agree
      ...
      change will be determined at Our sole discretion. By continuing to access
      or use Our Service after those revisions become effective, You agree to be
      bound by the revised terms. If You do not agree to the new terms, in whole
      or in part, please stop using the website and the Service. Contact Us
      ---------- If you have any questions about these Terms and Conditions, You
      can contact us: * By email: morseylane@gmail.com * By visiting this page
      on our website: https://fancreate.netlify.app/contact`;
  return (
    <div className="">
