    ...
    <div className="priv-wrapper">
      ...
      <p className="px-5 m-0" style={{ lineHeight: "2.5rem" }}>
        <section>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Morse Lane.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to FanCreate, accessible from{" "}
                <a
                  href="https://www.fancreate.netlify.app"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.fancreate.netlify.app
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: morseylane@gmail.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://fancreate.netlify.app/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://fancreate.netlify.app/contact"
                </a>
              </p>
            </li>
          </ul>
